...
CREATE TABLE `sets` (
    ...
    UNIQUE INDEX `sets_code_key`(`code`),
    INDEX `sets_releaseAt_idx`(`releaseAt`),
    INDEX `sets_type_idx`(`type`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Card` ADD CONSTRAINT `Card_setCode_fkey` FOREIGN KEY (`setCode`) REFERENCES `sets`(`code`) ON DELETE RESTRICT ON UPDATE CASCADE;
